...
def test_sort_by_date_reverse(user_list):
...
def test_sort_by_date(user_list):
...
def test_sort_by_date_same_date():
    assert sort_by_date([
        ...
        {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
        {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
        {'id': 41428829, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}], False) == [
        {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
...
def test_sort_by_date_uncorect_date():
    assert sort_by_date([
